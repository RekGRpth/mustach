 ...
 */
extern int mustach_cJSON_file(const char *template, cJSON *root, int flags, FILE *file);
 ...
 * a other negative value in case of error.
 */
extern int mustach_cJSON_fd(const char *template, cJSON *root, int flags, int fd);
 ...
 * a other negative value in case of error.
 */
extern int mustach_cJSON_mem(const char *template, cJSON *root, int flags, char **result, size_t *size);
 ...
 * a other negative value in case of error.
 */
extern int mustach_cJSON_write(const char *template, cJSON *root, int flags, mustach_write_cb_t *writecb, void *closure);
 ...
 * a other negative value in case of error.
 */
extern int mustach_cJSON_emit(const char *template, cJSON *root, int flags, mustach_emit_cb_t *emitcb, void *closure);
